...
$.ajax({
  ...
  success:function(result){
   ...
   if(day.getFullYear()==2017&&day.getMonth()+1==6&&day.getDate()==30){
      createActive()
    }
  ...
  success:function(result){
    ...
    //分享到朋友圈
               var share = {
                  ...
                  imgUrl: 'https://wechat.stuzone.com/iscuecer/lab_query/web/punch_card/img/shoutu.png' // 分享图标
                }
    ...
    //分享给朋友
            wx.onMenuShareAppMessage({
                ...
                imgUrl: 'https://wechat.stuzone.com/iscuecer/lab_query/web/punch_card/img/shoutu.png' // 早起打卡首页图片
            });
    ...
    //分享到qq
            wx.onMenuShareQQ({
                ...
                imgUrl: 'https://wechat.stuzone.com/iscuecer/lab_query/web/punch_card/img/shoutu.png' // 如上
            });
